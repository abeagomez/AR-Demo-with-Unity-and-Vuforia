...
{	
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {		
		...
		focalDistance01 = (focalTransform) ? (GetComponent.<UnityEngine.Camera>().WorldToViewportPoint (focalTransform.position)).z / (GetComponent.<UnityEngine.Camera>().farClipPlane) : FocalDistance01 (focalLength);
